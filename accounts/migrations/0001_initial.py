    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.CharField(choices=[('communities', 'Communities'), ('facilities', 'Health Facilities'), ('professionals', 'Individual Professionals'), ('partners', 'Partners'), ('pharmacies', 'Pharmacies'), ('patients', 'Patients/Users')], default='patients', max_length=20)),
                ('primary_role', models.CharField(choices=[('doctor', 'Doctor'), ('nurse', 'Nurse'), ('midwife', 'Midwife'), ('pharmacist', 'Pharmacist'), ('community_health_worker', 'Community Health Worker'), ('medical_assistant', 'Medical Assistant'), ('lab_technician', 'Lab Technician'), ('radiologist', 'Radiologist'), ('other', 'Other')], default='other', max_length=50)),
                ('is_verified', models.BooleanField(default=False)),
                ('verification_level', models.CharField(choices=[('basic', 'Basic'), ('verified', 'Verified'), ('professional', 'Professional'), ('admin', 'Administrator')], default='basic', max_length=20)),
