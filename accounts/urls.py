...
urlpatterns = [
    ...
    path(
        "create-health-professional-user/",
        views.CreateHealthProfessionalUserView.as_view(),
        name="create_health_professional_user",
    ),
    path(
        "create-pharmacy-user/",
        views.CreatePharmacyUserView.as_view(),
        name="create_pharmacy_user",
    ),
    path(
