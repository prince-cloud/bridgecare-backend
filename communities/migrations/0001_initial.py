# Generated by Django 5.1.2 on 2025-10-15 01:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner_organizations', models.JSONField(blank=True, default=list)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_facility', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.facility')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedules_created', to=settings.AUTH_USER_MODEL)),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedules', to='communities.healthprogram')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['program', 'scheduled_date'], name='program_sch_program_6d6c5d_idx'),
        ),
        migrations.AddIndex(
